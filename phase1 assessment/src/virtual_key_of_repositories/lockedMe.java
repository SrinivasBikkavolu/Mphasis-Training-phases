package virtual_key_of_repositories;
...
public class lockedMe 
{
	public static void main(String[] args) throws IOException, InterruptedException 
	{
		...
		String st;
		File mFolder =new File("E:\\git\\Mphasis-Trainig");
		mFolder.mkdir();
		String location = "E:\\git\\Mphasis-Trainig";
	    ...
	    switch(choice) {
	    case 1:
	    	File Fobj = new File("E:\\git\\Mphasis-Trainig");
	    ...
	    case 2:
		    ...
		    case 3:
		    	...
		    	st = sc.next();
		    	File fsearch = new File("E:\\git\\Mphasis-Trainig");
